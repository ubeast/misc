"""Tests for the dbricks_folder_archiver tool.
...
`sys.path` so it can be imported here as `dbricks_folder_archiver`; the guard
...
import dbricks_folder_archiver as dwa
